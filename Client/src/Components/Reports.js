...
const Reports = (props) => {
  ...
  return (
    <>
          ...
          <li className={classes.reportItem} key={report.id} id={report.id}>
            ...
            <div className={classes.liFooter}>          
              <p className={classes.alignLeft}>
                <Thumbnails pic1={report.pic1} pic2={report.pic2} pic3={report.pic3} expandImage={handleExpandImage} />
              </p>
      ...
      {showImageViewModal && <ImageViewModal image={imageUrl} unsetShowImageViewModal={handleUnsetImageViewModal}
          >
        </ImageViewModal>}
    </>
  )
