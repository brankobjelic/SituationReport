  ...
  return (
    <div className={classes.modal}>
      ...
      <form className={`${classes['modal-content']} ${classes['form-style-1']}`}>
        ...
        <br />
        <p>Moj komunalni  pomoćnik je platforma koja omogućava da na jednostavan način prijavite komunalne probleme sa kojima se susrećete svakodnevno, a možda ih do sada niste prijavili jer niste znali kome da se obratite.</p>
